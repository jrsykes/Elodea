...
val_dataset = CocoDetection(img_folder='/local/scratch/jrs596/dat/Meerkats/data/train', feature_extractor=feature_extractor, train=False)
...
#%%
checkpoint_pth = "dat/ElodeaProject/rudder_detr/model.ckpt"
