...
dist = distutils.core.run_setup("/home/userfs/j/jrs596/scripts/detectron2/setup.py")
#!python -m pip install {' '.join([f"'{x}'" for x in dist.install_requires])}
sys.path.insert(0, os.path.abspath('/home/userfs/j/jrs596/scripts/detectron2'))
